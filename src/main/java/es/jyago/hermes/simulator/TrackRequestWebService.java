...
@WebListener
public class TrackRequestWebService implements ServletContextListener {

    private static final Logger LOG = Logger.getLogger(TrackRequestWebService.class.getName());
